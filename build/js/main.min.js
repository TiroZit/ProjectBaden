...
const leisureSlider=new Swiper(".leisure__slider",{loop:!0,speed:300,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});
...
document.querySelectorAll(".tabs__link").forEach(e=>e.addEventListener("click",(function(t){t.preventDefault();const c=t.target.getAttribute("href").replace("#","");document.querySelectorAll(".tabs__link").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".leisure__list").forEach(e=>e.classList.remove("active")),e.classList.add("active"),document.getElementById(c).classList.add("active")}))),document.querySelector(".tabs__link").click();
